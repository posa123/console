...
public class UserPhoneView implements MainInterface{
	...
	public void checkInvoiceNumber() {
		ArrayList<String> inNumberList = UserPhoneController.getInstance().invoiceNumber();
		System.out.println("\n\n송장번호" );
		System.out.println("====================");
	...
	public void checkDeliveryStatus() throws InputMismatchException{
		...
		System.out.print("송장 번호 입력 : "); String invoiceNumber = ExtraUtil.getInstance().getScInstance().next();
